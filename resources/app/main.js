...
const client = require("discord-rich-presence")("642914209411366912");
const fs = require("fs");
...
const options = {
  ...
  title: "Fertig!",
  buttons: ["Danke"],
  message: "Ich habe es für dich gespeichert!"
};
let win;
/**
 * @return {undefined}
...
client.updatePresence({
  state: "Fortnite PUSHSERVER",
  details: "https://discord.gg/WfAhxHt",
  largeImageKey: "fn",
  smallImageKey: "bs",
  instance: true
}),
